          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {filteredMateri.map((materi) => {
              ...
              return (
                <div
                  key={materi.id}
                  className="bg-white rounded-3xl border border-slate-200/90 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5 flex flex-col justify-between overflow-hidden group"
                >
                  <div className="p-6">
                    {/* Badges */}
                    ...
                    <h3 
                      ...
                      className="text-base font-bold text-slate-900 group-hover:text-sky-600 transition-colors cursor-pointer mb-2 line-clamp-2"
                    >
                      {materi.title}
                    </h3>
                    ...
                    {materi.auditoryNotes && (
                      <div className="p-2.5 rounded-xl bg-indigo-50/70 border border-indigo-100 flex items-start gap-2 text-[11px] text-indigo-900 font-medium mb-4">
                        ...
                        <span className="line-clamp-2">Tips Audio: {materi.auditoryNotes}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="px-6 py-4 bg-slate-50/80 border-t border-slate-100 flex items-center justify-between gap-2">
                    <button
                      ...
                      className="p-2 rounded-xl text-sky-700 hover:bg-sky-100 border border-sky-200/60 transition-colors text-xs font-semibold flex items-center gap-1.5"
                    ...
                    <div className="flex items-center gap-2">
                      {linkedQuestions.length > 0 && (
                        <button
                          ...
                          className="px-3 py-1.5 rounded-xl bg-white hover:bg-slate-100 border border-slate-200 text-slate-700 text-xs font-bold transition-colors flex items-center gap-1"
                      ...
                      <button
                        onClick={() => onOpenMateri(materi.id)}
                        className="px-3.5 py-1.5 rounded-xl bg-sky-600 hover:bg-sky-500 text-white text-xs font-bold shadow-sm flex items-center gap-1 transition-all"
                      >
                        <span>Belajar</span>
